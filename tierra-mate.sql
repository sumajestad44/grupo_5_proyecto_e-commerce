...
--
-- Host: localhost    Database: tierra-mate
-- ------------------------------------------------------
...
CREATE TABLE `cart` (
  ...
  PRIMARY KEY (`id`),
  KEY `cart_FK_1` (`order`),
  CONSTRAINT `cart_FK` FOREIGN KEY (`id`) REFERENCES `users` (`id`),
  CONSTRAINT `cart_FK_1` FOREIGN KEY (`order`) REFERENCES `productcart` (`id`)
...
CREATE TABLE `productcart` (
  ...
  PRIMARY KEY (`id`),
  KEY `productcart_FK` (`idProduct`),
  CONSTRAINT `productcart_FK` FOREIGN KEY (`idProduct`) REFERENCES `products` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'tierra-mate'
--
